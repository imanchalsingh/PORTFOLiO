  ...
  const experiences = [
    {
      ...
      office: "Satya Niketan, New Delhi, India",
      location: "Remote",
      description:
        "Worked on full-stack development using Next.js, Prisma, and PostgreSQL. Focused on building responsive UIs, REST APIs, and seamless integration between client and server.",
    },
    {
      id: 2,
      type: "Internship",
      ...
      location: "Remote",
      description:
        "Built and Optimized web applications with Next.js and Tailwind CSS. Gained experience in responsive design, state management, and performance optimization.",
    },
    {
      id: 3,
      type: "Internship",
      ...
      location: "Remote",
      description:
        "Contributed to full-stack projects with MERN stack, focusing on REST APIs, authentication, and scalable web apps.",
    },
    {
      id: 4,
      type: "Internship",
          ...
          <div className="space-y-12">
            {experiences.map((item, index) => (
              ...
              >
                ...
                <div
                  className={`md:w-1/2 p-4 md:p-6 ${index % 2 === 0 ? "md:pr-8" : "md:pl-8"
                    }`}
                >
